...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:RxemzI2cHD0A8WyMqHu/UnDjfpGES/cmjtPbQoktWqs=",
        version = "v0.13.1",
    )
    go_repository(
        name = "com_github_azure_azure_sdk_for_go_sdk_internal",
        importpath = "github.com/Azure/azure-sdk-for-go/sdk/internal",
        sum = "h1:sLZ/Y+P/5RRtsXWylBjB5lkgixYfm0MQPiwrSX//JSo=",
        version = "v0.9.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:X2pnbLb6d+BWUBYUV5/0icAcsQ9LNbMFxun4RHPpXw0=",
        version = "v0.15.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:dm9/NjDskQVwAarmpeZ2UqLn1NKE8M3WHSHBS4jw2x8=",
    ...
    go_repository(
        ...
        sum = "h1:bagyhO7uFlYWedkh6mfIYf8LZGYnVGPYh2FqXisaOV4=",
        version = "v3.15.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:rwx9uVJU/fEmsmV5ECGRwdAiXgUm6k6tsFA+L8kQb6E=",
        version = "v1.14.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:bYrrjwH9Y7QUGk1MbchZDhRfmpGuEAs/D45sVjNbfvs=",
        version = "v1.14.5",
    )
    go_repository(
